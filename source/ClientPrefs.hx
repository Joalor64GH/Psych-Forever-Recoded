...
class ClientPrefs {
	...
	// Modded Specific
	public static var memorylevel:Bool = true;
	...
	public static var debugmode:Bool = false; // kinda useless if you ask me
	public static var antimash:Bool = false;
	public static var longnoteheal:Bool = true;
	public static var opponentsplash:Bool = true;
	...
	public static function saveSettings() {
		...
		FlxG.save.data.longnoteheal = longnoteheal;
	...
	public static function loadPrefs() {
		...
		if(FlxG.save.data.longnoteheal != null) {
			longnoteheal = FlxG.save.data.longnoteheal;
		}
